...
const dashboardHomeModuleRoutes = {
  tasks: resolveDashboardModuleRoutePath("tasks"),
  notes: resolveDashboardModuleRoutePath("notes"),
  memory: resolveDashboardModuleRoutePath("memory"),
  safety: resolveDashboardModuleRoutePath("safety"),
} satisfies Record<DashboardHomeModuleKey, string>;

function getRouteForModule(module: DashboardHomeModuleKey) {
  return dashboardHomeModuleRoutes[module] ?? resolveDashboardModuleRoutePath(module);
}
