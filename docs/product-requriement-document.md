...
| 高价值信息球       | 首页内优先级召回、待处理提醒、快速跳转详情           | P0-P1  |
| 任务状态模块       | 进行中 / 等待中 / 异常中 / 已结束任务查看与管理      | P0     |
| 便签协作模块       | 近期要做、后续安排、重复事项、已结束事项             | P0-P1  |
| 镜子模块           | 历史概要、阶段总结、用户画像、记忆管理               | P1     |
| 安全卫士模块       | 风险分级、待确认项、授权记录、恢复与费用             | P0-P1  |
...
- **P0-P1**：与主链路高度相关，建议尽早纳入，但可根据实现复杂度分阶段补齐。
